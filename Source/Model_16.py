...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Sequential(nn.Linear(256 * 2 * 4, 32), nn.LeakyReLU())  # first linear layer for encoder part
        self.l2 = nn.Sequential(nn.Linear(32, 256 * 2 * 4), nn.LeakyReLU()) # second linear layer for decoder part
        ...
        self.decoder = nn.Sequential(
            ...
            self.convTranspose_block(256, 256, 3),
                        
            #2
            nn.Upsample(size=(6,16), mode='bicubic', align_corners=True),
            self.convTranspose_block(256, 128, 3),
