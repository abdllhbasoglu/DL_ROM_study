...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Sequential(nn.Linear(128 * 4 * 8, 16), nn.LeakyReLU())  # first linear layer for encoder part
        self.l2 = nn.Sequential(nn.Linear(16, 128 * 4 * 8), nn.LeakyReLU()) # second linear layer for decoder part
